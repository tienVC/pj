...
<head>
  ...
  <link href="http://localhost:8000/Admin/public/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="http://localhost:8000/Admin/public/css/./sb-admin-2.min.css" rel="stylesheet" type="text/css">
  <script src="http://localhost:8000/Admin/public/vendor/jquery/jquery.min.js"></script>
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <script src="http://localhost:8000/Admin/public/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

      <!-- Core plugin JavaScript-->
      <script src="http://localhost:8000/Admin/public/vendor/jquery-easing/jquery.easing.min.js"></script>

      <!-- Custom scripts for all pages-->
      <script src="http://localhost:8000/Admin/public/js/sb-admin-2.min.js"></script>

      <!-- Page level plugins -->
      <script src="http://localhost:8000/Admin/public/vendor/chart.js/Chart.min.js"></script>

      <!-- Page level custom scripts -->
      <script src="http://localhost:8000/Admin/public/js/demo/chart-area-demo.js"></script>
      <script src="http://localhost:8000/Admin/public/js/demo/chart-pie-demo.js"></script>
